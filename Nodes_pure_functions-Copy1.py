...
from DataClassNode import DataInputs

@pwf.as_function_node
def Struct_gen(I:DataInputs.dataclass):
    """
...
@pwf.as_function_node
def GeometryOptimization(I:DataInputs.dataclass,
...
@pwf.as_function_node
def ForceMinimization(I:DataInputs.dataclass, 
                      return_as_dataclass:bool=True):
    """
